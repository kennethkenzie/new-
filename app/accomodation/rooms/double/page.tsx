...
const DoubleRoomPage = () => {
  ...
  const amenities = [
    { icon: <FaBed className="text-[#C49A6C]" />, name: "Two Comfortable Beds" },
  ...
  const galleryImages = [
    "https://ik.imagekit.io/67mog36hf/Labrezi/MYC_8040.jpg?updatedAt=1731997026952",
    "https://ik.imagekit.io/67mog36hf/Labrezi/double-room-2.jpg?updatedAt=1234567890",
    "https://ik.imagekit.io/67mog36hf/Labrezi/double-room-3.jpg?updatedAt=1234567890",
    "https://ik.imagekit.io/67mog36hf/Labrezi/double-room-bathroom.jpg?updatedAt=1234567890"
  ];
      ...
      <div className="relative h-64 md:h-[400px] w-full">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-3xl md:text-4xl font-bold mb-3">Double Room</h1>
            <p className="text-lg md:text-xl">Spacious comfort for two</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
            <div className="lg:col-span-2 bg-white p-6 md:p-8 rounded-lg shadow-sm">
              <h2 className="text-2xl md:text-3xl font-bold text-[#4A3F36] mb-4 md:mb-6">Spacious Double Accommodation</h2>
              <p className="text-[#4A3F36] mb-4 md:mb-6">
                Our well-appointed double rooms offer 20 m² of comfortable space with two beds, 
                perfect for friends traveling together or families with one child. Enjoy modern 
                amenities and thoughtful design for a relaxing stay.
              </p>
              <p className="text-[#4A3F36] mb-6 md:mb-8">
                The room features ample storage space, a comfortable seating area, and large windows 
                that let in plenty of natural light while maintaining your privacy.
              </p>
              ...
              <div className="mb-8 md:mb-12">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-[#4A3F36]">20 m² of comfortable space</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-[#C49A6C] rounded-full mt-2 mr-2"></span>
                    <span className="text-[#4A3F36]">Two single beds or one double bed option</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-[#C49A6C] rounded-full mt-2 mr-2"></span>
                    <span className="text-[#4A3F36]">Comfortable seating area</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-[#C49A6C] rounded-full mt-2 mr-2"></span>
                    <span className="text-[#4A3F36]">Ample storage space</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm h-fit sticky top-4">
              ...
              <p className="text-[#C49A6C] text-lg md:text-xl font-medium mb-4 md:mb-6">UGX 120,000 / night</p>
          ...
          <div className="mt-12 md:mt-16">
            ...
            <div className="relative w-full h-64 md:h-96 overflow-hidden rounded-lg">
              ...
              <Image
                ...
                alt={`Double Room ${currentImageIndex + 1}`}
                fill
          ...
          <div className="mt-12 md:mt-16 bg-white p-6 md:p-8 rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              ...
              <div>
                ...
                <p className="text-[#4A3F36] text-sm md:text-base">
                  Non-smoking rooms. Maximum occupancy: 3 guests. Children under 12 stay free with adults.
                </p>
              </div>
            </div>
          </div>
