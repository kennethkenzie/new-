    ...
    <div className="flex flex-col">
      ...
      <section className="bg-[#F6F0E5] min-h-[60vh] text-[#4A3F36] flex flex-col items-center justify-center py-20 px-6">
        ...
        <div className="text-center mb-20">
          <p className="text-sm italic tracking-wide mb-2">La Brezi Suites Sonde</p>
          <h1 className="text-5xl font-light tracking-widest uppercase mb-4">Contact Us</h1>
          <p className="text-xs tracking-widest text-gray-400">Jinja Misindye</p>
        </div>

        <div className="border-t border-gray-500 w-full max-w-4xl mb-12"></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-4xl text-center md:text-left">
          ...
          <div className="text-[#4A3F36] text-lg underline">
            <a href="tel:+256768262479" className="hover:text-gray-300">+256 768 262 479</a> <br /> <a href="tel:+256753208767" className="hover:text-gray-300">+256 753 208 767</a>  
          </div>
          
        </div>

        <div className="border-t border-gray-500 w-full max-w-4xl mt-12 mb-12"></div>
        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-red-600 text-white p-6 mb-8">
              ...
              <ul className="list-disc pl-5">
                {errors.map((error, index) => (
                  <li key={index} className="uppercase text-sm">{error}</li>
                ))}
              </ul>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <option value="La Brezi Suites Sonde">La Brezi Suites Sonde</option>
            ...
            <div className="flex justify-end mt-8 md:col-span-2">
              <button
                type="submit"
                className="bg-black uppercase py-3 px-8 hover:bg-gray-800 transition tracking-widest text-sm text-[#4A3F36]"
              >
                Submit
              </button>
            </div>
